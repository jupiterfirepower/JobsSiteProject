    ...
    ICacheService cacheService, IMapper mapper) : IProcessingService
{
    ...
    {
        await CheckAndLoadCategoriesData();
    ...
    {
        await CheckAndLoadEmploymentTypesData();
    ...
    {
        await CheckAndLoadWorkTypesData();
